...
|  
2+^| Use method that make sense for you (https://www.npmjs.com/package/ua-parser-js[ua-parser-js] or similar), take into account that browsers alter user-agent value when user asks desktop site from mobile device.
| *Step 2* 
...
Refresh QR code each second over 60 second period
